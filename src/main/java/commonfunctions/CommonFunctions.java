...
//						flag = webDB.clickAnElement(CommonFunctionsLocators.NEXTBUTTON, ElementType.Xpath);
...
////								ElementType.Xpath);
//						
//						int nextbutton = webDB.getDriver().findElements(By.xpath("//button[@class='p-paginator-next p-paginator-element p-link']")).size();
//						
////						boolean nextbutton = webDB.isElementDisplayed("//button[@class='p-paginator-next p-paginator-element p-link p-disabled']", ElementType.Xpath);
//						if (nextbutton == 1) {
...
//				else
//				{
//					log.logging("info", "No pagination as less or no records");
//					flag = true;
//				}
//			}
//		} else {
	        ...
	        if (totalrecordscount > 20) {
	            ...
	            try {
	                ...
	                while (true) {
	                    ...
	                    int recordsOnCurrentPage = webDB.getDriver()
	                            .findElements(By.xpath(
	                                    CommonFunctionsLocators.TOTALRECORDSCOUNT))
	                            .size();

	                    totalRecordsFromAllPages =
	                            totalRecordsFromAllPages + recordsOnCurrentPage;
	                    ...
	                    // Next button locator only for ENABLED button
	                    ...
	                    List<WebElement> nextButtons =
	                            webDB.getDriver().findElements(nextButtonLocator);

	                    // If no enabled next button found
	                    ...
	                    ((JavascriptExecutor) webDB.getDriver()).executeScript(
	                ...
	                if (totalRecordsFromAllPages == totalrecordscount) {
