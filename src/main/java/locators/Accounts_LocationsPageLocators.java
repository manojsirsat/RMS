...
public class Accounts_LocationsPageLocators 
{
	...
	// Create new Location
	/**XPATH*/ public static final String CREATE_NEW_LOCATION_BTN = "//button[@id='create-loc-button']";
	/**XPATH*/ public static final String NAME_INPUTFIELD = "//input[@id='name']";
	/**XPATH*/ public static final String SHORTNAME_INPUTFIELD = "//input[@id='short']";
	/**XPATH*/ public static final String CODE_INPUTFIELD = "//input[@id='code']";
	/**XPATH*/ public static final String LOCATIONTYPE_DRPDWN = "//input[@id='location_type_id']";
	/**XPATH*/ public static final String LOCATIONTYPE_DRPDWN_OPTIONS = "(//ul[@id='location_type_id_list']//li)";
	
	/**XPATH*/ public static final String ACCOUNT_DRPDWN = "//div[@id='account_id']";
	/**XPATH*/ public static final String ACCOUNT_DRPDWN_OPTIONS = "(//ul[@id='account_id_list']//li)";
	/**XPATH*/ public static final String ZONE_DRPDWN = "//div[@id='zone_id']";
	/**XPATH*/ public static final String ZONE_DRPDWN_OPTIONS = "(//ul[@id='zone_id_list']//li)";
	/**XPATH*/ public static final String REGION_DRPDWN = "//div[@id='region_id']";
	/**XPATH*/ public static final String REGION_DRPDWN_OPTIONS = "(//ul[@id='region_id_list']//li)";
	/**XPATH*/ public static final String CALLPRIORITY_DRPDWN = "//div[@id='call-priority-auto-complete']";
	/**XPATH*/ public static final String CALLPRIORITY_DRPDWN_OPTIONS = "(//ul[@id='call-priority-auto-complete_list']//li)";
	
	/**XPATH*/ public static final String PROGRAM_DRPDWN = "//div[@id='program-dropdown']";
	/**XPATH*/ public static final String PROGRAM_DRPDWN_OPTIONS = "(//ul[@id='program-dropdown_list']//li)";
	/**XPATH*/ public static final String LOCATIONTYPE_RADIOBTN = "//input[@class='p-inputswitch-input']";
	
	
	/**XPATH*/ public static final String ADDRESS_INPUTFIELD = "//input[@id='address']";
	...
	/**XPATH*/ public static final String CONTACTPHONECOUNTYCODE_DRPDWN = "//div[@id='contact-phone-country-code-autocomplete']";
	/**XPATH*/ public static final String CONTACTPHONECOUNTYCODE_DRPDWN_OPTIONS = "(//ul[@id='contact-phone-country-code-autocomplete_list']//li)";
	/**XPATH*/ public static final String CONTACTPHONECOUNTYCODE_SELECTED = "//div[@id='contact-phone-country-code-autocomplete']/input";
	/**XPATH*/ public static final String CONTACTPHONE_INPUTFIELD = "//input[@id='contact_phone']";
	/**XPATH*/ public static final String BUSINESSPHONECOUNTYCODE_DRPDWN = "//div[@id='business-phone-country-code-autocomplete']";
	/**XPATH*/ public static final String BUSINESSPHONECOUNTYCODE_DRPDWN_OPTIONS = "(//ul[@id='business-phone-country-code-autocomplete_list']//li)";
	/**XPATH*/ public static final String BUSINESSPHONECOUNTYCODE_SELECTED = "//div[@id='business-phone-country-code-autocomplete']/input";
	/**XPATH*/ public static final String BUSINESSPHONE_INPUTFIELD = "//input[@id='contact_phone']";
	/**XPATH*/ public static final String BUSINESSPHONE_EXT_INPUTFIELD = "//input[@id='bus_phone_ext']";
	/**XPATH*/ public static final String FAX_INPUTFILED = "//input[@id='fax']";
	
	/**XPATH*/ public static final String NOTES_INPUTFILED = "//textarea[@id='notes']";
	/**XPATH*/ public static final String DELIVERYNOTES_INPUTFILED = "//textarea[@id='delivery_notes']";
	/**XPATH*/ public static final String RECOVERYNOTES_INPUTFILED = "//textarea[@id='recovery_notes']";
	/**XPATH*/ public static final String REQUESTEDDELIVERYWINDOW_INPUTFILED = "//input[@id='requested_delivery_window']";
	/**XPATH*/ public static final String REQUESTEDPICKUPWINDOW_INPUTFILED = "//input[@id='requested_pickup_time']";
